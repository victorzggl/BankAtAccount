...
select 'account_send' [table_name], acs.account_send_id [primary_key], acs.html_template_version_id, acs.language_id,
	...
	a.zip [ZIP],
	null [SIGNATORY_EMAIL],
	null [SIGNATORY_NAME],
	null [SIGNATORY_CONTACT_ID],
	null [SIGNATORY_PERSONAL_TAX_NUM],
...
and htt.code not in ('CERTIFIED_COLLECTIONS_EMAIL','INVOICE','INVOICE_MULTILINE','INVOICE_GAS')
...
select 'cust_send' [table_name], cs.cust_send_id [primary_key], cs.html_template_version_id, cs.language_id,
	...
	ht.[url] + cs.web_reg_key [URL],
	c.zip [ZIP],
	bc.signatory_email [SIGNATORY_EMAIL],
	bc.signatory_name [SIGNATORY_NAME],
	bc.signatory_contact_id [SIGNATORY_CONTACT_ID],
	bc.signatory_personal_tax_num [SIGNATORY_PERSONAL_TAX_NUM],
	bc.bank_account_name [BANK_ACCOUNT_NAME]
from cust_send cs
join cds.dbo.html_template_version htv on cs.html_template_version_id = htv.html_template_version_id
join cds.dbo.html_template ht on htv.html_template_id = ht.html_template_id
