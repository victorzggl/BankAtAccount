...
select bc.bank_contract_id [bank_id] /*ReleaseStageBeta Remove In Final Release*/, bc.bank_reg_key, bc.signatory_email [email], bc.bank_account, b.bank_account_key, bc.bank_account_name
from bank b
