...
GO
alter procedure [dbo].[cds_UI_InsertCustPayment] @cust_id int, @cust_payment_type_id int, @payment_date datetime = null, @payment_amount decimal(18,2), @settlement_date date = null, @tran_num varchar(100) = null, @cds_user_id int, @bank_contract_id int = null
as 
...
begin
	select @bank_contract_id = bank_contract_id
	from dbo.cds_fn_GetActiveBankContract (null, @cust_id, null)
	if @@rowcount > 1
		set @error += '; cannot determine bank contract for the requested transaction'
end
