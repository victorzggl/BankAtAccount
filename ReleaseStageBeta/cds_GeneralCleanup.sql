...
insert into #bank_contract (bank_contract_status_id, cust_id, signed_date, start_date, end_date, document_key, signatory_email, signatory_name, signatory_contact_id, signatory_personal_tax_num, bank_account_name, bank_account, contract_id, bank_id, bank_reg_key, bank_type_id, bank_authorization_key)
select case when bs.code = 'ACTIVE' then 3 /*ACTIVE*/ else 4 /*INACTIVE*/ end bank_contract_status_id, b.cust_id, c.signed_date, c.start_date, mx_contract.end_date, c.document_key, c.contract_email signatory_email, null signatory_name, null signatory_contact_id, null signatory_personal_tax_num, null bank_account_name, b.bank_account, c.contract_id, b.bank_id, b.bank_reg_key, b.bank_type_id, b.bank_authorization_key
from bank b
...
insert into bank_contract (bank_contract_status_id, cust_id, signed_date, start_date, end_date, document_key, signatory_email, signatory_name, signatory_contact_id, signatory_personal_tax_num, bank_account_name, bank_account, contract_id, bank_id, inserted_date, updated_date, bank_type_id, bank_authorization_key, bank_reg_key)
select bank_contract_status_id, cust_id, signed_date, start_date, end_date, document_key, signatory_email, signatory_name, signatory_contact_id, signatory_personal_tax_num, bank_account_name, bank_account, contract_id, bank_id, inserted_date, updated_date, bank_type_id, bank_authorization_key, bank_reg_key
from #bank_contract bc
where contract_id is null

-- insert into account_bank_contract (account_id, bank_contract_id, start_date, end_date, active_flag)
select a.account_id, bc.bank_contract_id, bc.start_date, bc.end_date, case when bc.end_date is not null then 0 else 1 end
from bank_contract bc
join cust c on c.cust_id = bc.cust_id
