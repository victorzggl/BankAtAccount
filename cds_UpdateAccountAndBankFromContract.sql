...
insert into #update (ord_account_id, contract_id, account_id, ord_account_status, account_status, cust_id, bank_type_id, document_key, bank_account, account_num, facility_id, personal_tax_num, business_tax_num, bank_change_flag, account_change_flag, bank_account_name, signatory_email, signatory_name,	signatory_personal_tax_num,	signatory_contact_id)
...
left join (select cust_id, first_name, last_name, max(contact_id) contact_id from contact group by cust_id, first_name, last_name ) con on con.cust_id = oa.cust_id and con.first_name = oct.first_name and con.last_name = oct.last_name
...
begin
	select @bank_id = null, @cust_id = cust_id, @bank_type_id = bank_type_id, @bank_account = bank_account,
			...
			@signatory_email = signatory_email, @signatory_name = signatory_name, @signatory_contact_id = signatory_contact_id, @signatory_personal_tax_num = signatory_personal_tax_num
